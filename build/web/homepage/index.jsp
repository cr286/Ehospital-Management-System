                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                ...
                                <h5 data-animation="fadeInUp" data-delay="400ms">More than 30 professionals</h5>
                                <div class="slide-btn-group mt-50" data-animation="fadeInUp" data-delay="700ms">
                                    <a href="../patientpanel/" class="btn medica-btn">Make an Appointment</a>
                                    <a href="#" class="btn medica-btn ml-2 btn-2">Read More</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row no-gutters">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="medica-emergency-card wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <p>15 bed Emergency Room with a resuscitation room and a stand-by trauma team. 24hr consultant on stand-by.</p>
                            <a href="#">Read More</a>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="medica-appointment-card wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <form action="#" method="post">
                                ...
                                <a href="../patientpanel/" class="btn medica-btn mt-15" type="button">Make an Appointment</a>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-7">
                        <div class="medica-about-text">
                            <h2>Welcome to <span>E</span> Hospital</h2>
                            <p>E-hospital is an online Hospital management system software project that serves the functionality of hospital. This is proposed web application to provide basic services to doctors, patients and other hospital staffs. The users can view the doctors of different departments and they can get idea to visit the respective doctors related to their diseases. </p>
                            <ul>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-service-area wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h5>Laboratory</h5>
                        <p> Laboratory available for all kinds of research and testings. </p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-service-area wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <p> Ambulance available 24 Hrs </p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-service-area wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <h5>Radiology</h5>
                        <p> A variety of imaging techniques such as X-ray radiography, ultrasound are available. </p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-service-area wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <p> Dial 01-5261235 / 9817283681 </br> for Emergency Services Consult</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="single-service-area">
                        ...
                        <h5>Pharmacy</h5>
                        <p> All kinds of medicines available.</p>
                    </div>
                </div>
                    ...
                    <div class="medica-appointment-card">
                        ...
                        <form action="#" method="post">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <a href="../patientpanel/" type="button" class="btn medica-btn mt-15">Make an Appointment</a>
                                </div>
                            </div>
                        </form>
                    </div>
