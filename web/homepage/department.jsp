...
Department dep= depDao.getById(did);
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <!-- Title -->
                        <h3 class="breadcumb-title">Department</h3>
                        <!-- Breadcumb -->
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-7">
                    <div class="medica-about-text">
                        ...
                        <p><%=dep.getDepartmentDescription()%></p>
            ...
            <div class="row">
                <%
                    for (Doctor doc : docDao.getAll()) {
                        if(dep.getDepartmentId()==doc.getDepartment_id()){
                                        %>
                ...
                <div class="col-12">
                    <div class="see-all-doctors text-center wow fadeInUp" data-wow-delay="1s">
                        <a href="doctors.jsp" class="btn medica-btn btn-2">See All Doctors</a>
                    </div>
                </div>
            </div>
        </div>
