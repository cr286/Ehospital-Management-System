...
<div class="col-md-9">
    ...
    <div class="panel panel-default">
        <div class="panel-heading main-color-bg">
            <h3 class="panel-title"> <a class="btn btn-primary" href="AppointmentAdd.jsp" role="button"> New Appointment</a> <img role="button" src="../../uploads/excel.png" style="width:4%;" onclick="tableToExcel('table', 'W3C Example Table')" /></h3>
        </div>
